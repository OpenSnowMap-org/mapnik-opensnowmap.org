    ...
    f.write("""\
        <Rule>
            ...
            <LineSymbolizer stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
			 stroke="#FFFFFF" offset=\""""+str(Offsets[id]*1*1.1)+"""\" stroke-opacity="0.9"  smooth="1" gamma=".8"/>
        </Rule>
        <Rule>
		    <Filter>[osm_id]="""+str(id)+""" </Filter>
            &maxscale_zoom11;
            ...
            <LineSymbolizer stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
			 stroke="#FFFFFF" offset=\""""+str(Offsets[id]*2*1.1)+"""\" stroke-opacity="0.9"  smooth="1" gamma=".8"/>
        </Rule>
        <Rule>
		    <Filter>[osm_id]="""+str(id)+""" </Filter>
            &maxscale_zoom12;
            ...
            <LineSymbolizer stroke-width="5" stroke-linecap="round" stroke-linejoin="round"
			 stroke="#FFFFFF" offset=\""""+str(Offsets[id]*3*1.1)+"""\" stroke-opacity="0.9"  smooth="1" gamma=".8"/>
        </Rule>
        <Rule>
		    <Filter>[osm_id]="""+str(id)+""" </Filter>
            &maxscale_zoom14;
            ...
            <LineSymbolizer stroke-width="7" stroke-linecap="round" stroke-linejoin="round" 
			 stroke="#FFFFFF" offset=\""""+str(Offsets[id]*4*1.1)+"""\" stroke-opacity="0.9"  smooth="1" gamma=".8"/>
        </Rule>
        """)
...
f.write("""\
        <Rule>
            ...
            &minscale_zoom11;
            <LineSymbolizer stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
			 stroke="#FFFFFF" stroke-opacity="0.9"  smooth="1" gamma=".8"/>
        </Rule>
        <Rule>
		    <ElseFilter/>
            &maxscale_zoom11;
	...
	if (id in Colors) and isColor(Colors[id]):
        ...
        <Rule>
            ...
            <LineSymbolizer stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
			 stroke=\""""+str(color)+"""\" offset=\""""+str(Offsets[id]*1*1.1)+"""\" smooth="1" gamma=".8"/>
        </Rule>
        <Rule>
		    <Filter>[osm_id]="""+str(id)+""" </Filter>
            &maxscale_zoom11;
            ...
            <LineSymbolizer stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
			 stroke=\""""+str(color)+"""\" offset=\""""+str(Offsets[id]*2*1.1)+"""\" smooth="1" gamma=".8"/>
        </Rule>
        <Rule>
		    <Filter>[osm_id]="""+str(id)+""" </Filter>
            &maxscale_zoom12;
            &minscale_zoom14;
            <LineSymbolizer stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
			 stroke=\""""+str(color)+"""\" offset=\""""+str(Offsets[id]*3*1.1)+"""\" smooth="1" gamma=".8"/>
        </Rule>
        <Rule>
		    <Filter>[osm_id]="""+str(id)+""" </Filter>
            &maxscale_zoom14;
            ...
            <LineSymbolizer stroke-width="4" stroke-linecap="round" stroke-linejoin="round" 
			 stroke=\""""+str(color)+"""\" offset=\""""+str(Offsets[id]*4*1.1)+"""\" smooth="1" gamma=".8"/>
        </Rule>
        """)
	else:
        ...
        <Rule>
            ...
            &minscale_zoom11;
            <LineSymbolizer stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
			 stroke="#44b2a3" offset=\""""+str(Offsets[id]*1*1.1)+"""\" smooth="1" gamma=".8"/>
        </Rule>
        <Rule>
		    <Filter>[osm_id]="""+str(id)+""" </Filter>
            &maxscale_zoom11;
            &minscale_zoom12;
            <LineSymbolizer stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
			 stroke="#44b2a3" offset=\""""+str(Offsets[id]*2*1.1)+"""\" smooth="1" gamma=".8"/>
        </Rule>
        <Rule>
		    <Filter>[osm_id]="""+str(id)+""" </Filter>
            &maxscale_zoom12;
            &minscale_zoom14;
            <LineSymbolizer stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
			 stroke="#44b2a3" offset=\""""+str(Offsets[id]*3*1.1)+"""\" smooth="1" gamma=".8"/>
        </Rule>
        <Rule>
		    <Filter>[osm_id]="""+str(id)+""" </Filter>
            &maxscale_zoom14;
            &minscale_zoom18;
            <LineSymbolizer stroke-width="4" stroke-linecap="round" stroke-linejoin="round" 
			 stroke="#44b2a3" offset=\""""+str(Offsets[id]*4*1.1)+"""\" smooth="1" gamma=".8"/>
        </Rule>
        """)
for c in colorList:
	...
	if isColor(c):
        ...
        <Rule>
            ...
            &minscale_zoom11;
            <LineSymbolizer stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
			 stroke=\""""+str(color)+"""\"  smooth="1" gamma=".8"/>
        </Rule>
        <Rule>
		    <Filter>[color]='"""+c+"""' or [colour]='"""+c+"""'</Filter>
            &maxscale_zoom11;
...
f.write("""\
        <Rule>
            ...
            &minscale_zoom11;
            <LineSymbolizer stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
			 stroke="#44b2a3"  smooth="1" gamma=".8"/>
        </Rule>
        <Rule>
		    <ElseFilter/>
            &maxscale_zoom11;
