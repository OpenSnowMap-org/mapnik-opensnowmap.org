...
imposm=# alter materialized view pistes_routes owner to imposm;
ALTER MATERIALIZED VIEW
imposm=# alter materialized view pistes_sites owner to imposm;
ALTER MATERIALIZED VIEW
imposm=# alter table landuse_resorts owner to imposm;
ALTER TABLE
